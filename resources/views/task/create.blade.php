    ...
    <div class="container">
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <a href="{{route('workspace.index')}}" class="btn btn-primary font-weight-bolder">
            ...
            <!--begin::Form-->
            <form action="{{ route('workspace.task.store', ['workspace' => $workspace->id]) }}" method="POST">
                @method('POST')
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="datetime-local" value="2022-01-01T13:45:00" id="example-datetime-local-input" name="due_date">
                    </div>
                </div>
