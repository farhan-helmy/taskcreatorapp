...
<body>
        ...
        <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
            ...
            <div class="carousel-item active">
                <div class="carousel-container">
                    <h2 class="animate__animated animate__fadeInDown">Selamat datang ke <span>Task Creator</span>
                    </h2>
                    <p class="animate__animated fanimate__adeInUp">Software untuk create task and workspace.</p>
    ...
    <footer id="footer">
        <div class="container">
            <h3>TaskCreatorapp</h3>
            <p>Your Number 1 TaskCreatorapp 🇲🇾</p>
